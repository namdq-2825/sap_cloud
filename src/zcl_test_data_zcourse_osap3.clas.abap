CLASS zcl_test_data_zcourse_osap3 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_TEST_DATA_ZCOURSE_OSAP3 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA: lt_course   TYPE STANDARD TABLE OF zcourse_osap3 WITH EMPTY KEY,
          lt_schedule TYPE STANDARD TABLE OF zschedule_osap3 WITH EMPTY KEY.
    ...
    TRY.
        ...
        DELETE FROM zcourse_osap3.

        INSERT zcourse_osap3 FROM TABLE @lt_course.
        ...
        DELETE FROM zschedule_osap3.

        INSERT zschedule_osap3 FROM TABLE @lt_schedule.
