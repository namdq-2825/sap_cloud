...
define view entity ZI_SCHEDULE_DSAP1 as select from zschedule_dsap1 as Schedule
  association to parent ZI_COURSE_DSAP1 as _Course on $projection.CourseUuid = _Course.CourseUuid
{
